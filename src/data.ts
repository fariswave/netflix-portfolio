...
export const DATA: {
  ...
  banners: Record<string, ProfileBanner>; // ← TYPE di sini
  ...
  banners: {
    creative: {
      ...
      linkedinLink: "https://www.linkedin.com/in/zahrasp/",
      profileSummary:
  ...
  projects: [
    {
      ...
      description: {
        brandmarketing:
          "Project focused on increasing user retention for a major Telco provider through data-driven marketing and UI enhancements.",
        creative:
          "A visual overhaul of the Telco mobile app, focusing on modern aesthetics and smooth animations to appeal to a younger demographic.",
      },
    ...
    },
    {
      ...
      description: {
        brandmarketing:
          "A strategic brand marketing campaign that boosted online sales by 25% through targeted social media and influencer outreach.",
        creative:
          "Captivating visual storytelling and high-end photography for a luxury beauty brand, emphasizing elegance and natural beauty.",
      },
    ...
    },
    {
      ...
      description: {
        brandmarketing:
          "Showcasing technical excellence to potential investors, highlighting reliability and scalability for enterprise clients.",
        creative:
          "Visualizing abstract cloud concepts through clean, technical diagrams and a professional UI dashboard.",
      },
    ...
    },
    {
      ...
      description: {
        brandmarketing:
          "Optimizing supply chain visibility for FMCG brands, ensuring products reach consumers efficiently and sustainably.",
        creative:
          "Designing an intuitive dashboard for logistics managers to track inventory and shipments in real-time.",
      },
    ...
    },
    {
      ...
      description: {
        brandmarketing:
          "Driving student enrollment through a user-friendly education platform with integrated progress tracking.",
        creative:
          "Creating an engaging and colorful learning environment for children, focusing on accessibility and gamification.",
      },
  ...
  workPermit: {
    ...
    summary:
      "Currently authorized to work in the United States under H-1B visa sponsorship",
    additionalInfo:
      "Valid work permit allowing employment with current employer until October 2026. Can be extended upon request.",
  },
};
